...
A lógica implementada (em modo normal) foi:
...
• **Pisca-amarelo simultâneo nos dois semáforos**, independente da presença de veículos
...
3. Com baixa luminosidade por longo período, o sistema ativa o modo noturno automaticamente.
...
* **Lucas Michel** - Desenvolveu parte da montagem física e grande parte da documentação final, adicionando os detalhes de funcionamento do circuito e suas funcionalidades.
